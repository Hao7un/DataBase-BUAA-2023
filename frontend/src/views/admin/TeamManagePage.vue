        ...
        <v-dialog v-model="createApplicationDialogVisible" width="900px" max-height="600">
          <div class="applications-container">
            ...
            <el-table :data="applicationList" border
              style="width: 99%; display: flex; justify-content: center; align-items: center;">
              ...
              <el-table-column label="操作" width="200px" align="center">
                <template #default="scope">
                  <el-button @click="handleAccept(scope.$index, scope.row, 'true')" type="primary"><span
                      style="color: white;">通过</span></el-button>
                  <el-button @click="handleAccept(scope.$index, scope.row, 'false')" type="warning"><span
                      style="color: white;">拒绝</span></el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
          ...
          <div class="members-container">
            ...
            <el-table :data="displayedMembers" style=" display: flex; justify-content: center; align-items: center;">
              ...
              <el-table-column label="操作" align="center">
                <template #default="scope">
                  <el-button type="warning" @click="handleDelete(scope.$index, scope.row)"><span
...
export default {
  ...
  methods: {
    ...
    handleSetTeamAvatarSubmit() {
      ...
      this.axios({
        method: 'post',
        url: 'http://localhost:8000/upload_team_avatar',
        data: formData
      })
        .then((res) => {
          console.log(res);
