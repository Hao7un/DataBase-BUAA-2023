    ...
    <div class="main-container">
        ...
        <div class="content-container">
            ...
            <div class="selector-container">
                ...
                <div class="right">
                    <el-switch
                        v-model="projectSortKey"
                        active-text="按日期升序排序"
                        inactive-text="按日期降序排序"
                    >
                    </el-switch>
                </div>
            </div>
                    ...
                    <el-card shadow="hover" v-for="project in displayedList" class="card">
                        <template #header>
                             <div style="display: flex; justify-content: center">
                                <span style="font-style: italic; font-weight: bold; font-size: x-large; position: absolute;">{{ project.name }}</span>
                                <span style="margin-left: 700px;">项目ID: {{ project.id }}</span>
                            </div>
                        </template>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width: 400px;">
                                <span><el-icon><Clock /></el-icon>&nbsp; 创建时间: {{ project.createdDate }}</span>
                                &nbsp; &nbsp; &nbsp;
                                <span v-if="project.category === '1'" style="color: red;"><el-icon><FolderOpened /></el-icon>&nbsp; 项目类别: 社区服务</span>
                                <span v-else-if="project.category === '2'" style="color: green;"><el-icon><FolderOpened /></el-icon>&nbsp; 项目类别: 科技科普</span>
                                <span v-else-if="project.category === '3'" style="color: paleturquoise;"><el-icon><FolderOpened /></el-icon>&nbsp; 项目类别: 支教助学</span>
                                <span v-else-if="project.category === '4'" style="color: orange;"><el-icon><FolderOpened /></el-icon>&nbsp; 项目类别: 体育赛事</span>
